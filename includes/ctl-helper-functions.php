...
function ctl_custom_style()
{
            ...
            $third_post_color=isset($ctl_options_arr['third_post'])?$ctl_options_arr['third_post']:"#79ce2f";
...
$styles.='.cool-timeline.white-timeline .timeline-post .iconbg-turqoise{
     box-shadow: 0 0 0 4px white, 0 0 0 8px '.$line_color.';
    }';
...
$styles.='.cool-timeline.white-timeline .timeline-post.first .timeline-content .content-title:before{
    border-left-color:'.$first_post_color.';
    border-right-color:'.$first_post_color.';
}

.cool-timeline.white-timeline.one-sided .timeline-post.first .timeline-content .content-title:before {
    border-right-color:'.$first_post_color.';
}';


$styles.='.cool-timeline.white-timeline .timeline-post.second .timeline-content .content-title:before{
    border-left-color:'.$second_post_color.';
    border-right-color:'.$second_post_color.';
}
.cool-timeline.white-timeline.one-sided .timeline-post.second .timeline-content .content-title:before {
    border-right-color:'.$second_post_color.';
    border-left-color: transparent;
}';

$styles.='.cool-timeline.white-timeline .timeline-post.third .timeline-content .content-title:before{
    border-left-color:'.$third_post_color.';
    border-right-color:'.$third_post_color.';
}
.cool-timeline.white-timeline.one-sided .timeline-post.third .timeline-content .content-title:before {
    border-right-color:'.$third_post_color.';
    border-left-color:'.$third_post_color.';
}';

$styles.='.cool-timeline-legend .first-color-background,
.cool-timeline.white-timeline  .timeline-post.first .timeline-content .content-title,
.cool-timeline.white-timeline  .timeline-post.first .icon-dot-full, .cool-timeline.one-sided.white-timeline .timeline-post.first .icon-dot-full,
.cool-timeline.white-timeline  .timeline-post.first .icon-color-white, .cool-timeline.one-sided.white-timeline .timeline-post.first .icon-color-white{
    background:'.$first_post_color.';
}';
$styles.='.cool-timeline-legend .second-color-background,
.cool-timeline.white-timeline  .timeline-post.second .timeline-content .content-title,
.cool-timeline.white-timeline  .timeline-post.second .icon-dot-full, .cool-timeline.one-sided.white-timeline .timeline-post .icon-dot-full,
.cool-timeline.white-timeline  .timeline-post.second .icon-color-white, .cool-timeline.one-sided.white-timeline .timeline-post .icon-color-white{
  background:'.$second_post_color.';
}';
$styles.='.cool-timeline-legend .third-color-background,
.cool-timeline.white-timeline  .timeline-post.third .timeline-content .content-title,
.cool-timeline.white-timeline  .timeline-post.third .icon-dot-full, .cool-timeline.one-sided.white-timeline .timeline-post.third .icon-dot-full,
.cool-timeline.white-timeline  .timeline-post.third .icon-color-white, .cool-timeline.one-sided.white-timeline .timeline-post.third .icon-color-white{
    background:'.$third_post_color.';
}';
$styles.='
.cool-timeline.white-timeline  .timeline-post.first .timeline-meta .meta-details{
    color:'.$first_post_color.';
}
.cool-timeline.white-timeline  .timeline-post.second .timeline-meta .meta-details{
    color:'.$second_post_color.';
}
.cool-timeline.white-timeline  .timeline-post.third .timeline-meta .meta-details{
    color:'.$third_post_color.';
}';
...
.cool-timeline.white-timeline .timeline-post.second .timeline-content .content-title:before {
    border-right-color:'.$second_post_color.';
    border-left-color: transparent;
}
.cool-timeline.white-timeline.compact  .timeline-post.ctl-left.first .timeline-content .content-title,
.cool-timeline.white-timeline.compact .timeline-post.ctl-left.first .icon-color-white, 
.cool-timeline.white-timeline.compact .timeline-post.ctl-left.first .icon-dot-full{
    background:'.$first_post_color.';
}
.cool-timeline.white-timeline.compact  .timeline-post.ctl-left.second .timeline-content .content-title,
.cool-timeline.white-timeline.compact .timeline-post.ctl-left.second .icon-color-white, 
.cool-timeline.white-timeline.compact .timeline-post.ctl-left.second .icon-dot-full{
    background:'.$second_post_color.';
}
.cool-timeline.white-timeline.compact  .timeline-post.ctl-left.third .timeline-content .content-title,
.cool-timeline.white-timeline.compact .timeline-post.ctl-left.third .icon-color-white, 
.cool-timeline.white-timeline.compact .timeline-post.ctl-left.third .icon-dot-full{
    background:'.$third_post_color.';
}
