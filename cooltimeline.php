...
if (!class_exists('Cool_Timeline')) {
   ...
   $options_panel->OpenTab('options_2');
          ...
          //Color field
          $options_panel->addColor('first_post',array('name'=> __('Senioren','apc'),'std'=>'#29b246', 'desc' => __('','apc')));
          $options_panel->addColor('second_post',array('name'=> __('Jugend','apc'),'std'=>'#ce792f', 'desc' => __('','apc')));
          $options_panel->addColor('third_post',array('name'=> __('Schulschach','apc'),'std'=>'#79ce2f', 'desc' => __('','apc')));
   $options_panel->CloseTab();
   ...
   $options_panel->OpenTab('options_3');
            ...
            $options_panel->addTypo('post_title_typo', array('name' => __("Story Title", "apc"), 'std' => array('size' => '14px', 'color' => '#000000', 'face' => 'Montserrat', 'style' => 'normal'), 'desc' => __('', 'apc')));
				...
				$options_panel->addRadio('post_title_text_style', array('none' => 'None', 'lowercase' => 'Lowercase',
