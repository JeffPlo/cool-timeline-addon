    ...
    class Ctl_Fa_Icons {
        ...
        public function ctl_metabox() {
            ...
            foreach ( $screens as $screen ) {
                ...
                add_meta_box( 'fa_type', __( 'Wähle Geschichte Typ', 'cool-timeline' ), array(
                    $this,
                    'ctl_type_metabox',
                ), $screen, 'side', 'high' );
            }
        ...
        public function ctl_type_metabox( $post ) {
            ...
            ?>
            <div class="fa-field-metabox">
                <input type="radio" name="fa_type" id="first" value="first" <?php echo $first; ?> />
                <label for="first"><?php _e( 'Senioren', 'cool-timeline' ); ?></label><br>
                <input type="radio" name="fa_type" id="second" value="second" <?php echo $second; ?> />
                <label for="second"><?php _e( 'Jugend', 'cool-timeline' ); ?></label><br>
                <input type="radio" name="fa_type" id="third" value="third" <?php echo $third; ?> />
                <label for="third"><?php _e( 'Schulschach', 'cool-timeline' ); ?></label>
            </div>
            <?php
        }
        ...
        public function ctl_save( $post_id ) {
            ...
            if ( isset( $_POST['fa_type'] ) ) {
                update_post_meta( $post_id, 'fa_type', $_POST['fa_type'] );
            }
        }
